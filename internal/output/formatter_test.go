...
func comprehensiveTestEvents() []models.Event {
	...
	return []models.Event{
		...
		},
		{
			...
			Author:         models.Person{Username: "reviewer1"},
		...
		},
		{
			...
			Title:          "Review as codeowner",
			Source:         models.SourceGitHub,
			URL:            "https://github.com/org/repo/pull/666",
			Author:         models.Person{Username: "contributor"},
